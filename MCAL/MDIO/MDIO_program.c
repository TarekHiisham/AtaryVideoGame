...
void mdio_setPortStatus(u8_t au8_port , u8_t au8_status)
{
    /*Switching over pin status*/
    switch(au8_status)
    {
        ...
        case INPUT_FLOAT:
            ...
            /*Clearing the specified port in DDRx register*/
            *garr_ddrArray[au8_port] &= (0x00);
        ...
        case INPUT_PULLUP:
            ...
            *garr_ddrArray[au8_port] &= (0x00);
            ...
            /*Setting the specified port in PORTx register*/
            *garr_portArray[au8_port] |= (0xFF);
        ...
        case OUTPUT:
            ...
            /*Setting the specified port in DDRx register*/
            *garr_ddrArray[au8_port] |= (0xFF);
...
void mdio_setPortData(u8_t au8_port ,u8_t au8_data)
{
    /*clearing old data from specfied port*/
    *garr_portArray[au8_port] &= (0x00) ;
    
    /*setting new data */
    *garr_portArray[au8_port] |= (au8_data) ;
}
